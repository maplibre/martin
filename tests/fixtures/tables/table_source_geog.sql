...
CREATE TABLE table_source_geog (
    gid serial PRIMARY KEY, geog GEOGRAPHY (GEOMETRY, 4326)
);

INSERT INTO table_source_geog (geog) VALUES ('SRID=4326;POINT(0 0)'::geography);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(-2 2)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;LINESTRING(0 0, 1 1)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;LINESTRING(2 2, 3 3)'::geography
);

INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(30 10)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
...
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;MULTIPOLYGON(((30 20, 45 40, 10 40, 30 20)),((15 5, 40 10, 10 20, 5 10, 15 5)))'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;MULTIPOLYGON(((40 40, 20 45, 45 30, 40 40)),((20 35, 10 30, 10 10, 30 5, 45 20, 20 35),(30 20, 20 15, 20 25, 30 20)))'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;GEOMETRYCOLLECTION(POINT(4 6),LINESTRING(4 6,7 10))'::geography
);
...
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84124343269863 11.927545216212339)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84022627741408 11.926919775099435)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84116724279622 11.926986082398354)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84129834730146 11.926483025982757)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84086326293937 11.92741281580712)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84083973422645 11.927188724740008)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.8407405154705 11.92659842381238)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.84029057105903 11.92711170365923)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
    'SRID=4326;POINT(142.8403402985401 11.927568375227375)'::geography
);
INSERT INTO table_source_geog (geog) VALUES (
