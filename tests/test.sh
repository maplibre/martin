...
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'cors.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.ssl_certificates.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.auto_publish.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.auto_publish.tables.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.auto_publish.functions.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.tables.table_source.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'postgres.functions.function_zxy_query.warning'. Please check your configuration file for typos."
test_log_has_str "$LOG_FILE" "WARN  martin::config] Ignoring unrecognized configuration key 'pmtiles.warning'. Please check your configuration file for typos."
