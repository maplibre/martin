...
test_log_has_str "$LOG_FILE" 'WARN  martin::postgres::resolver::query_tables] Table public.table_source has no spatial index on column geom'
test_log_has_str "$LOG_FILE" 'WARN  martin::postgres::resolver::query_tables] Table public.table_source_geog has no spatial index on column geog'
