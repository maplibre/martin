...
You may also want to generate a [config file](./configuration-File.md) using the `--save-config my-config.yaml`, and later edit it and use it with `--config my-config.yaml` option.
