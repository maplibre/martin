...
Postprocessing is configured via the `convert-to-mlt` and `convert-to-mvt` keys in the [configuration file](config-file/index.md#postprocessing), not through the HTTP API.
