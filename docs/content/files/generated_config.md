...
The shape of this file is described by the JSON Schema at [`schemas/config.json`](https://github.com/maplibre/martin/blob/main/schemas/config.json) — point your editor at it (e.g. via the [Red Hat YAML extension] for VS Code) for live validation and autocomplete.
