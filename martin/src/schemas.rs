...
/// as the example `generated_config.md` in the docs.
///
...
pub fn config_doc_yaml() -> String {
    ...
    out.push_str("<!-- This file is auto-generated by `just gen-schemas`. Don't edit it, edit the codes doc comments instead -->\n");");
out.push_str("\n");
out.push_str("
