...
mod reloaders {
    ...
    impl TileReloaders {
        /// Constructs every reloader and initializes the PostgreSQL sources; nothing is spawned until [`start`](Self::start).
        #[cfg_attr(
        ...
        /// Spawns every reload loop; a reloader that cannot start is logged and skipped.
        pub fn start(self) {
            #[cfg(feature = "mbtiles")]
