...
#[cfg(test)]
mod tests {
    use super::may_contain_arcs;

    #[test]
    fn linear_types_skip_linearization_in_any_spelling() {
        for t in [
            "POINT",
            "MULTIPOINT",
            "LINESTRING",
            ...
            assert!(!may_contain_arcs(Some(t)), "{t}");
        }
    }

    #[test]
    fn everything_else_is_linearized() {
        for t in [
            "GEOMETRY",
            "GEOMETRYCOLLECTION",
            "CIRCULARSTRING",
