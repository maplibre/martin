...
impl PostgresAutoDiscoveryBuilder {
    ...
    ///
    /// a) Finding the TableInfo instance in the discovered tables map `db_tables_info` that
    ///    matches the (schema, table, geometry_column) specified in the input `cfg_inf`'s values.
    /// b) Merging the result of the lookup with the values in `cfg_inf`, giving `cfg_inf` preference.
    ///
    ...
    ///
    /// a) Finding the FunctionInfo instance in the discovered functions map `db_functions_info` that
    ///    matches the (schema, function) values specified in the input `cfg_inf`'s values.
    /// b) Merging the result of the lookup with the values in `cfg_inf`, giving `cfg_inf` preference.
    ///
