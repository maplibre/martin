...
pub enum HillshadeFormat {
    ...
    #[serde(rename = "png")]
    Png,
    /// Lossless WebP. Around a third smaller than PNG on banded output.
    #[serde(rename = "webp")]
    Webp,
}
...
mod tests {
    ...
    fn auto_means_every_default() {
        ...
        ");
        insta::assert_snapshot!(resolved.fingerprint(), @"300:45:2.5:2.5:0:6:0.2:0:png");
    }
    ...
    fn request_overrides_apply_only_when_opted_in() {
        ...
        insta::assert_snapshot!(report, @"
        allow=false -> 300:45:2.5:2.5:0:6:0.2:0:png
        allow=true -> 180:45:2.5:2.5:0:0:0.2:0:png
        ");
    }
    ...
    fn every_parameter_can_be_overridden_by_a_request() {
        ...
        altitude=0 -> 300:0:2.5:2.5:0:6:0.2:0:png
        vertical_exaggeration=0 -> 300:45:0:2.5:0:6:0.2:0:png
        contrast=0 -> 300:45:2.5:0:0:6:0.2:0:png
        elevation_scale=10 -> 300:45:2.5:2.5:10:6:0.2:0:png
        toon_bands=0 -> 300:45:2.5:2.5:0:0:0.2:0:png
        ambient=0 -> 300:45:2.5:2.5:0:6:0:0:png
        ");
    }
