			...
			<div className="container mx-auto px-6">
				<div className="flex h-20 items-center justify-between">
					...
					<div className="flex items-center space-x-4">
						<HoverCard>
							...
							<HoverCardContent className="w-80">
								<div className="space-y-2">
									...
									<p className="text-sm">
										Access comprehensive guides and documentation for the Martin
										tile server.
									</p>
								</div>
							</HoverCardContent>
						...
						<HoverCard>
							<HoverCardTrigger asChild>
								<Button size="lg-icon" variant="outline" asChild>
									<a
							...
							<HoverCardContent className="w-60">
								<div className="space-y-2">
									...
									<p className="text-sm">
										View the source code, discuss issues and contribute to
										Martin.
									</p>
								</div>
							</HoverCardContent>
