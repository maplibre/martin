...
export function SpriteDownloadModal({
	...
	const spriteFormats: SpriteFormat[] = [
		{
					...
					<div className="mb-8 space-y-6">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div className="p-4 border rounded-lg bg-purple-50 border-purple-200">
								...
								<p className="text-sm text-purple-800 mb-4">
									Advanced format for scalable, high-quality rendering at any
									zoom level. Perfect for modern mapping applications.
								</p>
						...
						<div className="p-4 bg-gray-50 rounded-lg border">
							...
							<p className="text-sm text-gray-700">
								Use <strong>PNG</strong> for maximum compatibility and detailed
								graphics. Choose <strong>SDF</strong> for modern applications
								that need scalable icons and dynamic styling.
							</p>
						</div>
					</div>
