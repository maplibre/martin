...
* Generate [sprites](https://maplibre.org/martin/sources-sprites.html) and [font glyphs](https://maplibre.org/martin/sources-fonts.html) and serve [styles](https://maplibre.org/martin/sources-styles.html)
